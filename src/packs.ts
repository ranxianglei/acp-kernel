      ...
      pi: {
        promptSections: {
          acpTags: [
            ...
            `Refs remain stable across compression. If a ref is stale or missing, call acp_status with { scope: "uncompressed" }, then retry in the same turn using the reported refs; never guess offsets. Batch target ranges in one call.`,
